...
const HeaderComponent = () => {
  ...
  const handleSearchKeyDown = (e) => {
    ...
    if (e.key === "ArrowDown") {
      ...
      if (selected) window.location.href = `/dich-vu/${selected._id}`;
          ...
          {Object.keys(currentUser).length > 0 ? (
            <div className="dropdown">
              ...
              >
                {currentUser.name}
                <img
                  src={currentUser.avatar || "/img/carousel.jpg"}
                  alt="avatar"
